#    Contra-DC design in GDS factory
#    Authors: Joao Santos and Joana Tata   ; joana.tata@picadvanced.com
#    PICadvanced S.A., Portugal
#    (c)2024
...
def simple_contra_dc(
    ...
    # - draw corrugations of the Top waveguide
    ...
    # --- Fanout waveguides ---
    # -  draw inputs and outputs of the Top waveguide
    aux_cs = partial(gf.cross_section.cross_section, width=w1, cross_section=cross_section)
    bndwg = gf.components.bend_s((sbend_l, sbend_h), cross_section=aux_cs, add_pins=False)
    inwgb_r_w1 = wgt << bndwg.mirror((0, 1), (0, 0))
    aux_cs = partial(gf.cross_section.cross_section, width=w1, cross_section=cross_section)
    obndwg = gf.components.bend_s((sbend_l, sbend_h), cross_section=aux_cs, add_pins=False)
    ...
    # - draw corrugations of the Bottom waveguide
    halfp_ref = []
    for i in range(0, n, 1):
        halfp_l = gf.components.straight(
    ...
    # --- Fanout waveguides ---
    # - draw inputs and outputs of the Bottom waveguide
